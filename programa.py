...
while True:
	...
	res_db=db.numeros.insert({'num': num , 'day': localtime.tm_mday, 'month': localtime.tm_mon, 'year':localtime.tm_year, 'hour': localtime.tm_hour, 'min':localtime.tm_min, 'sec': localtime.tm_sec})	bbt.writeBulk("C_E_R", [{"resource": "num", "data": num},{"resource": "day", "data": localtime.tm_mday},{"resource": "month", "data": localtime.tm_mon},{"resource": "year", "data":localtime.tm_year},{"resource": "hour", "data": localtime.tm_hour},{"resource": "min", "data": localtime.tm_min},{"resource": "sec", "data": localtime.tm_sec}])
	del (res_db)
	del(string)
	del(string1)
	del(string2)
